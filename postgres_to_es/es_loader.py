...
module_logger = logging.getLogger('ESLoader')


class ESLoader:
    def __init__(self, hosts: list, chunk_size: int = 100):
    ...
    def init_indexes(self):
        ...
        for file in files:
            ...
            try:
                self.client.indices.create(index='movies', body=data)
            except exceptions.ElasticsearchException:
                module_logger.warning('index already exist: %s', 'movies')
